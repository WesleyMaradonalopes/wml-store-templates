...
export default function HeaderFilter(props) {
	...
	return (
		<View className='relative'>
			<View className='cursor-pointer transition-opacity hover:opacity-80'>
				<svg
					viewBox='0 0 24 24'
					fill='none'
			...
			{hasFilters && <View className='bg-primary-700 absolute -right-1 -top-0.5 h-3 w-3 rounded-full' />}
		</View>
	)
}
