...
const styles = StyleSheet.create({
  container: { flex: 1 },
	...
	primaryDadosText: { textDecorationLine: 'underline', color: '#0a0a0a' },
	logout: { alignSelf: 'flex-start', paddingVertical: Spacing.four, width: '100%', textAlign: 'center', borderTopWidth: 1, borderBottomWidth: 1, borderColor: '#dedbd5' },
	logoutText: { color: '#0a0a0a', fontWeight: '600', width: '100%', textAlign: 'center', borderWidth: 1, borderColor: '#0a0a0a', borderRadius: 5, padding: 8 },
	tileGrid: { display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start', flexWrap: 'wrap', gap: 5},
	tile: { width: '49%', padding: Spacing.three, borderRadius: 16, backgroundColor: '#e9e6df', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
	preferenceBlock: { gap: 4 },
	preference: { paddingVertical: Spacing.three, borderBottomWidth: 0, borderBottomColor: '#dedbd5', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
	notificationSwitch: { width: 30, height: 16, padding: 3, borderRadius: 14, justifyContent: 'center' },
	notificationSwitchOn: { backgroundColor: '#0a0a0a', alignItems: 'flex-end' },
	notificationSwitchOff: { backgroundColor: '#dedbd5', alignItems: 'flex-start' },
	notificationThumb: { width: 12, height: 12, borderRadius: 11, backgroundColor: '#ffffff', shadowColor: '#0a0a0a', shadowOpacity: 0.15, shadowRadius: 2, shadowOffset: { width: 0, height: 1 }, elevation: 2 },
	helpTitle: { fontSize: 18, textAlign: 'center' },
	helpButton: { padding: Spacing.four, borderRadius: 8, borderWidth: 1, borderColor: '#0a0a0a', alignItems: 'center' },
	powered: { textAlign: 'center', fontSize: 10, color: '#777' },
	card: { gap: Spacing.three, padding: Spacing.three, borderRadius: 8, backgroundColor: '#ffffff', borderWidth: 1, borderColor: '#e6e2dc' },
	cardTitle: { fontSize: 20 },
	divider: { height: 1, backgroundColor: '#dedbd5' },
	outlineButton: { padding: Spacing.three, borderRadius: 8, borderWidth: 1, borderColor: '#7b7772', alignItems: 'center' },
	googleButton: { flexDirection: 'row', justifyContent: 'center', gap: Spacing.two, minHeight: 48 },
	centerText: { textAlign: 'center' },
	input: { padding: Spacing.three, borderRadius: 8, backgroundColor: '#ffffff', borderWidth: 1, borderColor: '#e0ddd7', fontSize: 15, fontFamily: Fonts.sans },
	...
	genderDropdownIconOpen: { transform: [{ rotate: '-90deg' }] },
	dropdown: { borderWidth: 1, borderColor: '#e0ddd7', borderRadius: 8, backgroundColor: '#fff' },
	option: { padding: Spacing.three, borderBottomWidth: 1, borderBottomColor: '#eee' },
	textButton: { alignItems: 'center', padding: Spacing.two },
	...
	passwordRule: { fontSize: 12, lineHeight: 17 },
	passwordRuleValid: { color: '#2f8f5b' },
	passwordRuleInvalid: { color: '#df5f5f' },
	checkRow: { flexDirection: 'row', gap: Spacing.two, alignItems: 'center' },
	checkbox: { width: 18, height: 18, borderWidth: 1, borderColor: '#aaa', borderRadius: 4, alignItems: 'center', justifyContent: 'center' },
	checkboxMark: { color: '#ffffff', fontSize: 13, lineHeight: 16, fontWeight: '700' },
	resendButton: { padding: Spacing.four, borderRadius: 8, alignItems: 'center', backgroundColor: '#e7e3da' },
	resendText: { color: '#5d5955', fontWeight: '700' },
	checked: { backgroundColor: '#0a0a0a' },
	disabled: { opacity: 0.5 },
	notificationMessage: { color: '#9f1111', fontSize: 11, lineHeight: 16 },
  ...
  personalDataTitle: { marginBottom: 15, color: '#0a0a0a', fontFamily: Fonts.medium, fontSize: 20, lineHeight: 34, fontWeight: '500' },
