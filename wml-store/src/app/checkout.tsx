...
function ReviewHeader({ icon, title }: { icon: 'user' | 'truck' | 'card'; title: string }) {
  return <View style={styles.reviewHeader}>{icon === 'user' && <UserIcon color="#231f20" size={20} />}{icon === 'truck' && <TruckIcon color="#231f20" size={20} />}{icon === 'card' && <CreditCardIcon color="#231f20" size={20} />}<ThemedText style={styles.sectionTitle}>{title}</ThemedText></View>;
}
...
const styles = StyleSheet.create({
  ...
  secondaryText: { color: '#1e120d', fontFamily: Fonts.bold, fontSize: 14, fontWeight: '700' },
