...
const styles = StyleSheet.create({
  ...
  checkoutShelfTitle: { fontSize: 16, lineHeight: 20 },
  flex: { flex: 1 },
  ...
  emptyCartDescription: { maxWidth: 300, fontFamily: Fonts.sans, fontSize: 12, lineHeight: 17, textAlign: 'center' },
  ...
  customerDataDescription: { marginBottom: 24, color: '#0a0a0a', fontFamily: Fonts.sans, fontSize: 13, lineHeight: 20, fontWeight: '400' },
  customerDataRows: { gap: 21 },
  customerDataRow: { gap: 4 },
  customerDataLabel: { color: '#0a0a0a', fontFamily: Fonts.sans, fontSize: 14, lineHeight: 20, fontWeight: '400' },
  ...
  personalField: { gap: 6 },
  personalFieldLabel: { color: '#0a0a0a', fontFamily: Fonts.sans, fontSize: 14, lineHeight: 20, fontWeight: '400' },
  personalInput: { minHeight: 50, paddingHorizontal: 14, paddingVertical: 12, borderRadius: 8, borderWidth: 1, borderColor: '#0a0a0a', backgroundColor: '#ffffff', color: '#45413d', fontFamily: Fonts.sans, fontSize: 16, lineHeight: 22 },
  ...
  addressOption: { flexDirection: 'row', alignItems: 'flex-start', gap: Spacing.two, padding: Spacing.two, borderRadius: 8, borderWidth: 1, borderColor: '#d9d3cc', backgroundColor: '#ffffff' },
  ...
  primary: { minHeight: 48, padding: Spacing.four, paddingHorizontal: 20, borderRadius: 8, alignItems: 'center', justifyContent: 'center', backgroundColor: '#0a0a0a' },
  ...
  shippingOption: { flexDirection: 'row', alignItems: 'center', gap: Spacing.two, padding: Spacing.two, borderRadius: 8, borderWidth: 1, borderColor: '#b0a69b', backgroundColor: '#FFFFFF' },
  shippingOptionSelected: { borderColor: '#0a0a0a', borderWidth: 2 },
  shippingOptionDetails: { flex: 1, gap: 2 },
  pickupButton: { flexDirection: 'row', alignItems: 'center', gap: Spacing.two, padding: Spacing.two, borderRadius: 8, borderWidth: 1, borderColor: '#b0a69b', backgroundColor: '#FFFFFF' },
  pickupSelectedCard: { flexDirection: 'row', alignItems: 'flex-start', gap: Spacing.two, padding: Spacing.two, borderRadius: 8, backgroundColor: '#FFFFFF' },
  pickupStoreCard: { flexDirection: 'row', alignItems: 'flex-start', gap: Spacing.two, padding: 12, borderRadius: 8, borderWidth: 1, borderColor: '#b0a69b', backgroundColor: '#FFFFFF' },
  ...
  pixInfoCard: { minHeight: 50, flexDirection: 'row', alignItems: 'center', gap: Spacing.two, paddingHorizontal: Spacing.three, borderRadius: 8, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#f0ece8' },
  pixInfoIcon: { color: '#8b746b', fontSize: 22, lineHeight: 24 },
  pixInfoText: { flex: 1, color: '#0a0a0a', fontFamily: Fonts.sans, fontSize: 14, lineHeight: 20 },
  ...
  pixSectionTitle: { color: '#0a0a0a', fontFamily: Fonts.bold, fontSize: 15, lineHeight: 20, fontWeight: '700' },
  ...
  creditCardVisual: { minHeight: 168, padding: Spacing.three, borderRadius: 8, overflow: 'hidden', justifyContent: 'space-between', gap: Spacing.two },
  ...
  giftCardReviewTitle: { color: '#0a0a0a', fontFamily: Fonts.sans, fontSize: 13, lineHeight: 20 },
  ...
  modalCard: { width: '100%', maxWidth: 340, gap: Spacing.two, padding: 16, borderRadius: 8, backgroundColor: '#FFFFFF' },
  modalTitle: { textAlign: 'center', lineHeight: 26, fontSize: 16, marginBottom: Spacing.two, fontFamily: Fonts.medium, fontWeight: '500' },
	modalTitleProduct: {fontFamily: Fonts.bold, fontWeight: '700', lineHeight: 26, fontSize: 16},
  modalDeleteButton: { minHeight: 48, borderRadius: 8, alignItems: 'center', justifyContent: 'center', backgroundColor: '#0a0a0a' },
  modalCancelButton: { minHeight: 48, borderRadius: 8, borderWidth: 1, borderColor: '#0a0a0a', alignItems: 'center', justifyContent: 'center', backgroundColor: '#FFFFFF' },
