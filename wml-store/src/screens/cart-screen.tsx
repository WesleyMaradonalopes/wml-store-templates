...
export default function CartScreen() {
  ...
  return <ThemedView style={styles.container}><SafeAreaView style={styles.safeArea}>
    <ScreenHeader showSearch={false} showCart /><ThemedText type="subtitle">Sacola</ThemedText>{loading && <ActivityIndicator color="#000000" />}
...
const styles = StyleSheet.create({ container: { flex: 1 }, safeArea: { flex: 1, padding: Spacing.four, gap: Spacing.three }, list: { gap: Spacing.three, paddingVertical: Spacing.three }, row: { flexDirection: 'row', gap: Spacing.three, padding: Spacing.three, borderRadius: 16, backgroundColor: '#ffffff', shadowColor: '#000000', shadowOpacity: 0.1, shadowRadius: 6, shadowOffset: { width: 0, height: 1 }, elevation: 2 }, rowContent: { flex: 1, gap: Spacing.one }, image: { width: 88, height: 116, borderRadius: 10, backgroundColor: '#e8e8ea' }, button: { padding: Spacing.four, borderRadius: 24, alignItems: 'center', backgroundColor: '#1e120d' }, actions: { flexDirection: 'row', alignItems: 'center', gap: Spacing.two, marginTop: Spacing.one }, quantityButton: { width: 30, height: 30, borderRadius: 15, alignItems: 'center', justifyContent: 'center', backgroundColor: '#f0ece5' }, removeButton: { marginLeft: 'auto', paddingVertical: Spacing.one }, removeText: { color: '#B42318', fontSize: 12 } });
