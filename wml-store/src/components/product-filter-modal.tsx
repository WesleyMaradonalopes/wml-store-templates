...
const styles = StyleSheet.create({
  ...
  clearButton: { flex: 1, minHeight: 48, borderRadius: 6, borderWidth: 1, borderColor: '#1e120d', alignItems: 'center', justifyContent: 'center' },
  applyButton: { flex: 1, minHeight: 48, borderRadius: 6, alignItems: 'center', justifyContent: 'center', backgroundColor: '#1e120d' },
